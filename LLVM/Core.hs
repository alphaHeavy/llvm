...
setValueName str v@(Value a) = liftIO (setValueNameU str a) >> return v

-- |Set the name of a 'Value'.
setValueName_ :: MonadIO m => String -> Value a -> m ()
setValueName_ str (Value a) = liftIO $ setValueNameU str a
